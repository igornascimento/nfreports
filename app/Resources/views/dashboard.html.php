...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="<?php echo $view['assets']->getUrl('/lib/bootstrap/css/bootstrap.min.css'); ?>" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="<?php echo $view['assets']->getUrl('/lib/font-awesome/css/font-awesome.min.css'); ?>" rel="stylesheet" type="text/css">

    <!-- Custom CSS -->
    <link href="<?php echo $view['assets']->getUrl('/css/sb-admin.css'); ?>" rel="stylesheet">
...
<body>
    ...
    <script src="<?php echo $view['assets']->getUrl('/lib/jquery/jquery.js'); ?>"></script>

    <!-- Tether -->
    <script src="<?php echo $view['assets']->getUrl('/lib/tether/tether.min.js'); ?>"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="<?php echo $view['assets']->getUrl('/lib/bootstrap/js/bootstrap.min.js'); ?>"></script>

    <!-- Chart.js -->
    <script src="<?php echo $view['assets']->getUrl('/lib/chart.js/Chart.min.js'); ?>"></script>

    <!-- SB Admin JavaScript -->
    <script src="<?php echo $view['assets']->getUrl('/js/sb-admin.min.js'); ?>"></script>
